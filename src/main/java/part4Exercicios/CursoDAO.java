...
public class CursoDAO {
    ...
    public List<Curso> list() {
        ...
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            while(rs.next()){
                ...
                int duracao_horas = rs.getInt("duração_horas");
    ...
    public Curso getById(int id) {
        ...
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            if (rs.next()){
                ...
                curso.setDuracaoHoras(rs.getInt("duração_horas"));
            }
    ...
    public void create(Curso curso) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            String sql = "INSERT INTO curso(nome, duração_horas) VALUES(?, ?)";
    ...
    public void update(Curso curso) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            String sql = "UPDATE curso SET nome = ?, duração_horas = ? WHERE id = ?";
